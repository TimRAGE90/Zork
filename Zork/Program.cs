...
namespace Zork
{
    internal class Program
    {
        ...
        private static readonly Room[,] Rooms =
        {
            ...
            { new Room("Dense Woods"), new Room("South of House"), new Room("Clearing") }
        };
        ...
        private static void InitializeRoomDescriptions()
        {
            ...
            Rooms[2, 2].Description = "You are in a clearing, with a forest surround you on the west and south.";
        }
    }
}